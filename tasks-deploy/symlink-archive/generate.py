...
TITLE = "Задержаны мошенники, уговаривавшие пенсионеров покупать биткоины"
STATEMENT_TEMPLATE = '''
Сегодня в Комсомольске-на-Амуре задержаны двое подозреваемых в мошенничестве.
По данным следствия, задержанные приходили к пенсионерам и под видом сотрудников
пенсионного фонда убеждали их вложиться в криптовалюту Bitcoin. После этого пенсионеры переводили
им деньги и получали от мошенников документ, на котором утверждалось, что на переведённые деньги
выполнен вклад в Bitcoin и что с ростом курса криптовалюты будет регулярно увеличиваться пенсия.

В ходе обыска на месте задержания сотрудники правоохранительных органов изъяли ноутбук, принадлежащий одному
из подозреваемых, однако, к сожалению, не нашли на нём никаких улик. Им лишь удалось выяснить,
что подозреваемый пользовался [известным облачным хранилищем](http://storage.contest.qctf.ru).
Следователи уже связались с разработчиками этого сервиса, однако те отказались от сотрудничества.

*Примечание*: для аутентификации в сервисе нужно использовать логин `{}` и пароль `{}`
'''
