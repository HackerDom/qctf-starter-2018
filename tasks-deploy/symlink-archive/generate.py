...
пенсионного фонда убеждали их вложиться в криптовалюту Bitcoin. После операций
мошенники вручали пенсионерам распечатку документа, гласившего, что их ждёт регулярное
увеличение пенсии в соответствии с ростом курса криптовалюты и вложенной суммой.

В ходе обыска на месте задержания сотрудники правоохранительных органов изъяли ноутбук,
принадлежащий одному из подозреваемых, однако, к сожалению, им не удалось узнать ничего,
кроме того, что подозреваемый пользовался одним из облачных хранилищ. Следователи уже связались с
разработчиками [сервиса](http://storage.contest.qctf.ru), однако те отказались от сотрудничества.

__Примечание__: для пользования сервисом нужно использовать логин `{}` и пароль `{}`
'''
