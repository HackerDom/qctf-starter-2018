...
получить, только зная метод, использованный передающим лицом.

В качестве примера сотрудники Rubelfzederg Security приводят давно ставшее популярным
[изображение](/static/files/yykjklijlxtwmxe/{}) нескольких десятков котов и
собак. «Новейшие технологии, использующие в том числе искусственный
интеллект, позволили нам сделать однозначный вывод о наличии скрытой
информации в этой не вызывающей подозрений картинке», — говорят авторы в докладе.
